...
{
    [TableName("pelamar")]
    public class pelamar : BaseNotifyProperty, ICloneable
    {
        ...
        public string TTL
        {
            get
            {
                _ttl = TmpLahir + ", " + TglLahir.ToLongDateString();
                return _ttl;
            }
            set
            {
                _ttl = value;
                OnPropertyChange("TTL");
            }
        }
